...
import profileImage from '../Images/nocoderightgirl.jpg';
...
export const HomePage = () => {
    return (
        <div className="container text-center">
            ...
            <p>
                odgr-showです。主にHTML/CSS/Javascript/Reactメインに取り扱っています。Git、Github、Node.jsも使えます。趣味は料理、ファッション、インテリア、少しゲームかな？休みはもっぱらプログラミングの勉強ですw
                odgr-showです。主にHTML/CSS/Javascript/Reactメインに取り扱っています。Git、Github、Node.jsも使えます。趣味は料理、ファッション、インテリア、少しゲームかな？休みはもっぱらプログラミングの勉強ですw
            </p>
